package com.joandora.test.data;
...
public class SocketOutputStream extends OutputStream implements WritableByteChannel {
	...
	public Writer(WritableByteChannel channel, long timeout) throws IOException {
		super((SelectableChannel) channel, timeout);
		this.channel = channel;
	}

	public int performIO(ByteBuffer buf) throws IOException {
