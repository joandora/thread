...
public abstract class SocketIOWithTimeout {
	// This is intentionally package public.
	...
	public static SelectorPool selector = new SelectorPool();
	 ...
	 */
	public static void checkChannelValidity(Object channel) throws IOException {
		if (channel == null) {
			/*
	 ...
	 * @throws IOException
	 */
	public abstract int performIO(ByteBuffer buf) throws IOException;
	 ...
	 * @throws IOException
	 */
	public int doIO(ByteBuffer buf, int ops) throws IOException {
     ...
     * @throws IOException
     */
    public static void connect(SocketChannel channel, SocketAddress endpoint, int timeout) throws IOException {
	 ...
	 */
	public void waitForIO(int ops) throws IOException {
	...
	public static String timeoutExceptionString(SelectableChannel channel,
	...
	public static class SelectorPool {
		...
		public static final long IDLE_TIMEOUT = 10 * 1000; // 10 seconds.

		public ProviderInfo providerList = null;
		 ...
		 * @throws IOException
		 */
		public synchronized SelectorInfo get(SelectableChannel channel)
				throws IOException {
		 ...
		 * @param info
		 */
		public synchronized void release(SelectorInfo info) {
		 ...
		 * timeout.
		 */
		public void trimIdleSelectors(long now) {
